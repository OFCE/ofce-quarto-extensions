...
octobre 2025}};
      \node [anchor = east] at (8.5,-12){\textcolor{black}{Modifié le : 28
novembre 2025}};
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, colback=white, opacitybacktitle=0.6, coltitle=black, leftrule=.75mm, toprule=.15mm, title={Encadré \ref*{tip-e1}: les encadrés doivent fonctionner}, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, left=2mm, bottomrule=.15mm, breakable, rightrule=.15mm, arc=.35mm, toptitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, opacityback=0]
